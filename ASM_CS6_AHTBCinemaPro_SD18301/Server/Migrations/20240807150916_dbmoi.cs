        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_KhachHangs_Users_IDUser",
                        column: x => x.IDUser,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_NhanViens_Users_IDUser",
                        column: x => x.IDUser,
                        principalTable: "Users",
                        principalColumn: "IdUser",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NgayChieuPhim = table.Column<DateTime>(type: "datetime2", nullable: false),
                    TrangThai = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_NgayChieus", x => x.IdCaChieu);
                    table.ForeignKey(
                        name: "FK_NgayChieus_Phims_Phim",
                        column: x => x.Phim,
                        principalTable: "Phims",
                        principalColumn: "IdPhim",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_NgayChieus_Phongs_Phong",
                        column: x => x.Phong,
                        principalTable: "Phongs",
                        principalColumn: "IdPhong",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_GioChieus_NgayChieus_Cachieu",
                        column: x => x.Cachieu,
                        principalTable: "NgayChieus",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_NgayChieus_Phim",
                table: "NgayChieus",
                column: "Phim");

            migrationBuilder.CreateIndex(
                name: "IX_NgayChieus_Phong",
                table: "NgayChieus",
                column: "Phong");

            migrationBuilder.CreateIndex(
                name: "IX_NhanViens_IDUser",
                table: "NhanViens",
                column: "IDUser");
