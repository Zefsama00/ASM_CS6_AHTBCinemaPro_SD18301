...
namespace ASM_CS6_AHTBCinemaPro_SD18301.Server.Migrations
{
    ...
    [Migration("20240807150916_dbmoi")]
    partial class dbmoi
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ASM_CS6_AHTBCinemaPro_SD18301.Shared.Models.DanhMuc", b =>
                {
            ...
            modelBuilder.Entity("ASM_CS6_AHTBCinemaPro_SD18301.Shared.Models.DanhMucPhim", b =>
                {
                    b.Property<int>("IDDanhMucPhim")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.HasKey("IDDanhMucPhim");

                    b.HasIndex("IdDanhMuc");

                    b.HasIndex("IdPhim");

                    b.ToTable("DanhMucPhims");
                });
            ...
            modelBuilder.Entity("ASM_CS6_AHTBCinemaPro_SD18301.Shared.Models.DanhMucPhim", b =>
                {
                    b.HasOne("ASM_CS6_AHTBCinemaPro_SD18301.Shared.Models.DanhMuc", "DanhMuc")
                        .WithMany("DanhMucPhim")
                        .HasForeignKey("IdDanhMuc")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ASM_CS6_AHTBCinemaPro_SD18301.Models.Phim", "Phim")
                        .WithMany("DanhMucPhim")
